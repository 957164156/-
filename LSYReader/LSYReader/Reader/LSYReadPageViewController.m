...
@property (nonatomic,strong) UIPageViewController *pageViewController;//仿真翻页控制器
@property (nonatomic,strong) DZMCoverController *converController;//覆盖翻页
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.config = [LSYReadConfig shareInstance];
    //根据当前的配置确定当前的控制器
    if (self.config.currentEffect == effectSimulation) {//仿真
...
- (DZMCoverController *)converController {
